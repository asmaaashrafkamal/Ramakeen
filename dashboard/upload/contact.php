...
<body>
  ...
  <nav class="navbar navbar-expand  navbar-dark" style="background-color: black; opacity: 100%;">
    <a  style="color:white;float: left; padding: 5px; " href="./Ramakeen EN/contact.php">EN</a>
...
<!--end nav1 -->
 ...
 <a href="#"  style="color: rgb(206, 180, 117)!important;">اتصل بنا</a>
</div>
</div>
...
<nav class="w3-sidebar w3-bar-block w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none ; z-index: 99;" id="mySidebar">
  ...
  <a href="reservation.php" onclick="w3_close()" class=" w3-button nav-link"> <span class="menuside"> طلب خدمة </span></a> <hr>
  <a href="request.php" onclick="w3_close()" class=" w3-button nav-link"> <span class="menuside"> طلب وساطة </span></a> <hr>
  <a href="#" onclick="w3_close()" class=" w3-button nav-link" style="color: rgb(206, 180, 117)!important;"> <span class="menuside"> اتصل بنا </span></a> <hr>
</nav>
...
<section id="contact" >
  <div class="container">
      ...
      <?php
               if(!empty($m)){
                if($m=="fail"){
                  echo '<div style=""><div class="alert alert-success"  style="max-width: 600px;"  role="alert"><h4 style="text-align:center;"> لم يتم عمل الطلب بنجاح حاول مرة اخري  </h4> </div></div>';
                  }else{
                    echo '<div style=""><div class="alert alert-success"  style="max-width: 600px;"  role="alert"><h4 style="text-align:center;">تم عمل الطلب بنجاح </h4> </div></div>';
                  }
                }
                ?>
                </div>
       ...
       <div class="row" dir="rtl" >
        <div class="col-md-6 info" >
          ...
          <div class="contact-info">
              ...
              <h5 class=""> <span> <i class="fa fa-home contact-address"></i></span>العنوان  </h5>
              <p>  مبنى سيجنتشر3 – الدور الأول طريق الأمير تركي بن عبدالعزيز الأول <br> حطين, الرياض 13512</p> <br>
              
              <h5> <span><i class="fa fa-mobile contact-address"></i></span> الهاتف</h5> 
              <a href="tel: +966 11 200 20 66" dir="ltr" class="contact-details"> +966 11 200 20 66 <a> <br>
                <a href="tel: +966 555 648 636" dir="ltr"  class="contact-details" >+966 555 648 636  <a> <br> <br>
              
              <h5 > <span><i class="fa fa-envelope contact-address"></i></span> البريد الالكتروني</h5> 
          ...
          <div class="col-md-6">
              <form method="POST">
                  ...
                  <div class="form-group">
                    <input type="number" class="form-control" name="phone" id="exampleInputPassword1" placeholder="رقم الهاتف">
                  </div>
                  <div class="form-group">
                      <input type="email" class="form-control" name="email" id="exampleInputPassword1" placeholder="البريد الالكتروني">
                    </div>
                    <div class="form-group">
                      <textarea class="form-control" rows="6" name="messages" id="comment" placeholder="الملاحظات"></textarea>
                    </div>
                    <a href="#" ><button type="submit" class="btn btn-rounded btn" name="contact" > ارسال </button> </a>
