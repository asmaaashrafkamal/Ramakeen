...
<body class="rtl menu-on-right white-content">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
      <div class="content" style=" padding: 80px 20% 30px 30px;">
      <?php
      $i=0;
      echo'<div class="row">';
      foreach($show1 as $r){
...
<div class="row">
<div class="col-md-12" style="padding-right:40%">
<form method="POST"><button type="submit" class="btn btn-danger" value="'.$r["request_id"].'" name="delete1">delete</button></form>
</div>
</div>
</div>
        </div>
 ...
 if(isset($_POST['delete1'])){
  $delete1=new Admin();
  $message=$delete1->delete_elwasata($_POST['delete1']);
  if($message=="success"){
    echo '<meta http-equiv=Refresh content="0;url=elwasata.php?reload=1">';
  }else{
    echo("حاول مرة أخري");
  }
}
