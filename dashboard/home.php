...
$req=new Admin();
$s4=$req->request_no();
//SELECT count(*) FROM registration  WHERE role = 'admin';
      ...
      <div class="content" style=" padding: 80px 27% 30px 30px;">
        ...
        <div class="row" style="">
          <div class="col-lg-4 text-right">
            <div class="card card-chart">
              <div class="card-header ">
                <h5 class="card-category">عدد الأدمن</h5>
                <h3 class="card-title"><i class="tim-icons icon-bell-55 text-primary "></i> <?php echo $s1; ?></h3>
              </div>
              <div class="card-body ">
          ...
          <div class="col-lg-4 text-right">
            <div class="card card-chart">
              <div class="card-header ">
                <h5 class="card-category">عدد طلبات الوساطة</h5>
                <h3 class="card-title"><i class="tim-icons icon-delivery-fast text-info "></i> <?php echo $s2; ?></h3>
              </div>
              <div class="card-body ">
          ...
          <div class="col-lg-4 text-right">
            <div class="card card-chart">
              <div class="card-header ">
                <h5 class="card-category">اتصل بنا</h5>
                <h3 class="card-title"><i class="tim-icons icon-send text-success "></i><?php echo $s3; ?></h3>
              </div>
              <div class="card-body ">
        ...
        <div class="row">
            <div class="col-lg-4 text-right">
                <div class="card card-chart">
                  <div class="card-header ">
                    <h5 class="card-category">طلبات الخدمة</h5>
                    <h3 class="card-title"><i class="tim-icons icon-bell-55 text-primary "></i> <?php echo $s4; ?></h3>
                  </div>
                  <div class="card-body ">
