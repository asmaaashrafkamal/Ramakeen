...
<body class="rtl menu-on-right white-content">
  <div class="wrapper ">
    <div class="sidebar" style="background-color: black;width:260px;">
      <!--
                ...
                <div class="card card-chart">
                  ...
                  <?php
                        if($show2!=NULL){
                          ...
                          <th style=" font-weight: 1000;font-size: 20px;">الاسم</th><th style=" font-weight: 1000;font-size: 20px;">الإيميل</th><th style=" font-weight: 1000;font-size: 20px;">الهاتف</th><th style=" font-weight: 1000;font-size: 20px;">الملاحظات</th><th style=" font-weight: 1000;font-size: 20px;">حذف الطلب</th>
                          </thead>
                        <tbody>';
                          
                        foreach( $show2 as $r){
                         echo '<tr><td>'.$r["name"].'</td><td>'.$r["email"].'</td><td>'.$r["phone"].'</td><td>'.$r["observation"].'</td><td><form method="POST"><button type="submit" class="btn btn-danger" value="'.$r["id"].'" name="delete1">delete</button></form></td></tr>';   
                      }}
                      else{
                        echo "<h1 style='text-align:center;'> لا يوجد رسائل حتي الان</h1>";
                      }
                      ?>
                      </tbody>
                  </table>
 ...
 if(isset($_POST['delete1'])){
  $delete1=new Admin();
  $message=$delete1->delete_contact($_POST['delete1']);
  if($message=="success"){
    echo '<meta http-equiv=Refresh content="0;url=contact.php?reload=1">';
  }else{
    echo("حاول مرة أخري");
  }
}
