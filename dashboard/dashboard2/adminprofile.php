            ...
            <div class="col-lg-12 text-right">
                <div class="card card-chart">
                  <div class="card-header ">
                    <h3 class="card-title" style="text-align: center;text-decoration:underline;font-size: 40px; "> admin profile</h3>
                  </div>
                  <div class="card-body" style="text-align: center;"  >
                  <div class="big-circle">
                  <div class="small-circle"></div>
                    </div>
                  <h2 style="color:goldenrod">welcome <?php echo $data->username; ?></h2>
                  <h3 style="color:goldenrod">phone:</h3> <p style="color:rgb(150, 141, 141) ; padding: 0 20px;margin-bottom: 25px;font-size:large;font-style: italic;"><?php echo $data->mobile; ?></p>
                  <h3 style="color:goldenrod">Email:</h3><p style="color:rgb(150, 141, 141) ;padding: 0 20px;margin-bottom: 25px;font-size:large;font-style: italic;"><?php echo $data->email; ?></p>
                  <h3 style="color:goldenrod">updated_at:</h3><p style="color:rgb(150, 141, 141) ;padding: 0 20px;margin-bottom: 25px;font-size:large;font-style: italic;"><?php echo $data->updated_at; ?></p>
                  <h3 style="color:goldenrod">Social Media:</h3>
