    ...
    <div class="main-panel">
      ...
      <div class="card card-chart">
        ...
        <div class="col-md-12">
          ...
          <p class="bmd-label-floating" style=" font-weight: 1000;font-size: 20px;">'.$r["service_type"].'</a></p>         
          </div>
        ...
        <div class="col-md-12">
          ...
          <label class="bmd-label-floating" style=" font-weight: 1000;font-size: 20px;">'.$r["applicant_status"].'</a></label>         
        ...
        <div class="col-md-12" >
          ...
          <label class="bmd-label-floating" style=" font-weight: 1000;font-size: 20px;">'.$r['type'].'</label>         
        ...
        <div class="col-md-12">
          ...
          <label class="bmd-label-floating" style=" font-weight: 1000;font-size: 20px;">'.$r["created_at"].'</label>         
