...
<body class="rtl menu-on-right white-content">
                ...
                <div class="card card-chart">
                  ...
                  <?php
                        if($show1!=NULL){
                          ...
                          <th style=" font-weight: 1000;font-size: 20px;">حذف الطلب</th>
                          </thead>
                        <tbody>';
                        ...
                        foreach( $show1 as $r){
                         ...
                         value="'.$r["service_id"].'" name="delete1">delete</button></form></td></tr>';   
                      }}
                      else{
 ...
 if(isset($_POST['delete1'])){
  $delete1=new Admin();
  $message=$delete1->delete_service($_POST['delete1']);
  if($message=="success"){
    echo '<meta http-equiv=Refresh content="0;url=services.php?reload=1">';
  }else{
    echo("حاول مرة أخري");
  }
}
