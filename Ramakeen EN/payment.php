...
$id=$_GET['id'];
$ser=$_GET['ser'];
if($_GET['ser']=="Applicant With Legal Advice"){
$price=199;
}else {
  $price=99; 
}
...
<head>
 ...
 <div class="navmenu">
  ...
  <a href="request.php" style="color: rgb(206, 180, 117)!important;">  Mediation request</a>
...
<nav class="w3-sidebar w3-bar-block w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none ; z-index: 99;" id="mySidebar">
 ...
 <a href="contact.php" onclick="w3_close()" class=" w3-button nav-link"> <span class="menuside">  Contact Us </span></a> <hr>
    ...
    <!-- Table Reservation Form -->
        ...
        if(isset($_GET['pay'])){
          if($_GET['pay']==1){
          echo '<div style=""><div class="alert alert-success"  style="max-width: 600px;"  role="alert"><h4 style="text-align:center;">Payment Completed Successfully </h4> </div></div>';
        }else{
          echo '<div style=""><div class="alert alert-danger"  style="max-width: 600px;"  role="alert"><h4 style="text-align:center;">Payment Failed</h4> </div></div>';
        }
      }
        ?>
    				<h2 style=" font-weight: 600; letter-spacing: .5px;" > Payment Operation   </h2>
    			</div>
    		</div> <br> <br>
